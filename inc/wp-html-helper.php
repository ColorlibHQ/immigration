...
// image default alt
if( ! function_exists( 'immigration_img_default_alt' ) ) {
	function immigration_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'immigration_img_tag' ) ) {
	function immigration_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = immigration_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'immigration_anchor_tag' ) ) {
	function immigration_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'immigration' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'immigration_heading_tag' ) ) {
	function immigration_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'immigration' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'immigration_paragraph_tag' ) ) {
	function immigration_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'immigration_other_tag' ) ) {
	function immigration_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'immigration_button_element ' ) ) {
	function immigration_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'immigration' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
