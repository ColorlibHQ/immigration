...
esc_html__( '[ Immigration ] Newsletter Form', 'immigration' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'immigration' ), ) 
);
...
<div id="mc_embed_signup" class="immigration-subscribe-newsletter newsletter-form">
	<form target="_blank" novalidate action="<?php echo esc_url( $actionurl ); ?>" id="mc-embedded-subscribe-form" method="post" class="navbar-form">
		...
		<input type="email" name="EMAIL" class="form-control" placeholder="<?php esc_html_e( 'Email address', 'immigration' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Newsletter', 'immigration' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'immigration'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_html_e( 'Short Description:' ,'immigration'); ?></label> 
