/**
 * Immigration Elementor widgets, front end: the Mailchimp signup form, the
 * about and review carousels, the booking form's date fields, the gallery and
 * the counters. No jQuery.
 */
(function () {
  'use strict';
