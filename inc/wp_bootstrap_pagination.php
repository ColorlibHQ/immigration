...
function immigration_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'immigration' ),
        'next_string'     => esc_html__( '&raquo;', 'immigration' ),
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'immigration_pagination_defaults', $defaults )
    );
