...
class Immigration_Enqueue {

	public $scripts = array();

	public function immigration_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'immigration_frontend_enqueue_scripts', ) );
	}

	public function immigration_frontend_enqueue_scripts( ) {
